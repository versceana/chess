...
public class Main1 {
    ...
    public static void main(String[] args) {
        ...
        } catch (InvalidNumberOfInsectException e) {
            throw new RuntimeException(e);
...
class Ant extends Insect implements OrthogonalMoving, DiagonalMoving {
    ...
    @Override
    Insect.getBestDirection();

    @Override
    Insect.travelDirection();

    @Override
    DiagonalMoving.getDiagonalDirectionVisibleValue();

    @Override
    DiagonalMoving.travelDiagonally();

    @Override
    OrthogonalMoving.getOrthogonalDirectionVisibleValue();

    @Override
    OrthogonalMoving.travelOrthogonally();
...
abstract class Insect extends BoardEntity {
    ...
    private EntityPosition calculateNewPosition(EntityPosition currentPosition, Direction direction) throws InvalidEntityPositionException {
        switch (direction) {
            case NE:
